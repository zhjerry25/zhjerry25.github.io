...
export const zh = {
  ...
  home: {
    hero: "Aether-archive",
    tagline:
      "本站是一个高中生的个人知识库，主要更新化学、计算机、数理和其它我感兴趣的领域的内容 ^_^ 整理笔记、资源和工具，欢迎关注",
    recentUpdates: "最近更新",
    noNotes: "暂无笔记，请稍后再来！",
    viewAll: "查看所有笔记 →",
    whatIsThis: "这是什么？",
  ...
  seo: {
    homeDescription: "Aether-archive 本站是一个高中生的个人知识库，主要更新化学、计算机、数理和其它我感兴趣的领域的内容 ^_^ 整理笔记、资源和工具，欢迎关注",
